        ...
        <div className="w-full h-full xl:max-w-[1280px]">
          ...
          <div className="grid sm:grid-cols-12 gap-4">
            ...
            <div className="sm:col-span-10">
              <div className="w-full  h-full bg-white shadow-btn rounded-2xl border-[1px] border-gray py-6 min-h-[442px] relative overflow-hidden">
                <img
                  id="circle"
                  src={circle}
                  alt=""
                  className="absolute bottom-[1%] right-[-20%] z-[0] opacity-40"
                />
                {Menu_Links == false ? (
                  <div className="w-full  h-full flex flex-col justify-center items-center  z-[1]">
                    <GiTalk className="w-40 h-40 text-black/10 z-[1]" />

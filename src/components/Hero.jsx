          ...
          <div className="my-4 w-full py-4 bg-black/80 fixed z-[99] shadow-sm text-white">
            <div className="text-center flex flex-col justify-center">
              <div className="flex justify-center items-center text-base">
                ...
                <p> <strong>Esse site usa cookies</strong></p>

              </div>

              <p>Cookies: a gente guarda estatísticas de visitas para melhorar sua experiência de navegação, saiba mais em nossa <strong className="text-secondary"><a href="www.google.com"> política de privacidade</a></strong>.</p>
              <div className="flex justify-center">
                <a onClick={() => setCookies(!cookies)} className="font-bold text-secondary bg-white rounded-lg px-2 py-1 mt-2 cursor-pointer">Aceitar e fechar</a>

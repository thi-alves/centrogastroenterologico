...
const Contact = () => {
  const inputStyle = "w-full placeholder:text-gray_red px-4 py-6 outline-none rounded-xl border border-1 border-gray bg-gray/20 shadow-sm text-secondary font-bold h-10 hover:border-secondary placeholder:font-normal duration-300 transition-colors"
  return (
    <section id="contact">
      <div className="my-10">
        <div className="w-full bg-secondary/[4%] shadow-sm  relative overflow-hidden ">
          ...
          <div className="container mx-auto py-16 flex flex-col sm:flex-row gap-4">
            ...
            <div className="w-full  sm:w-1/2 relative z-[1] bg-white shadow-btn rounded-2xl p-8">
